    ...
    <section className="grid grid-cols-1 lg:grid-cols-12 my-4">
      <div className="col-span-7 place-self-center place-items-center grid lg:place-items-start">
        ...
        <p className="text-gray-400 mb-6 text-lg lg:text-xl">
          Passionate about crafting sleek, functional digital experiences.
        </p>
        <div>
          <button className="bg-gradient-to-br from-blue-600 to-gray-700 hover:bg-blue-500 text-white px-6 py-3 rounded-full mr-4 transition-all duration-300 ease-in-out transform hover:scale-105">
            Hire Me
          </button>
